...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"font-picker.js":[function(require,module,exports) {
"use strict";
...
},{}],"font-weight-picker.js":[function(require,module,exports) {
"use strict";
...
function FontWeightPicker(_ref) {
  ...
  return e(SelectControl, _objectSpread(_objectSpread({}, props), {}, {
    options: options
  }));
}
},{}],"block-attributes.js":[function(require,module,exports) {
"use strict";
...
},{"./font-picker":"font-picker.js","./font-weight-picker":"font-weight-picker.js"}],"resize.js":[function(require,module,exports) {
...
},{}],"data-subscription.js":[function(require,module,exports) {
var _window$wp = window.wp,
...
},{}],"fragment.js":[function(require,module,exports) {
var _window$wp = window.wp,
    __ = _window$wp.i18n.__,
    e = _window$wp.element.createElement,
...
},{}],"code-editor.js":[function(require,module,exports) {
"use strict";
...
var _default = memo(function (_ref) {
  ...
  var ref = useRef();
  useEffect(function () {
    var editor = initialize(ref.current, _objectSpread(_objectSpread({}, defaultSettings), {}, {
      codemirror: _objectSpread(_objectSpread({}, defaultSettings.codemirror), {}, {
        tabSize: 2,
        mode: mode,
        lineNumbers: false
      })
...
},{"./code-editor":"code-editor.js"}],"plugin.js":[function(require,module,exports) {
"use strict";
...
registerPlugin('slide', {
  render: function render() {
    ...
    var updateMeta = function updateMeta(value, key) {
      return editPost({
        meta: _objectSpread(_objectSpread({}, meta), {}, _defineProperty({}, key, value))
      });
    };
    ...
    return [].concat(_toConsumableArray(Object.keys(bodyRules).map(function (key) {
      ...
      onChange: function onChange(value) {
        ...
        editPost({
          meta: _objectSpread(_objectSpread({}, meta), {}, (_objectSpread3 = {}, _defineProperty(_objectSpread3, bgColorKey, value), _defineProperty(_objectSpread3, backgroundGradientKey, ''), _objectSpread3))
        });
      }
      ...
      onChange: function onChange(value) {
        editPost({
          meta: _objectSpread(_objectSpread({}, meta), {}, _defineProperty({}, backgroundOpacityKey, 100 - value + ''))
        });
      }
    })), e(PluginDocumentSettingPanel, {
      ...
      onSelect: function onSelect(media) {
        ...
        if (!media || !media.url) {
          ...
          editPost({
            meta: _objectSpread(_objectSpread({}, meta), {}, (_objectSpread5 = {}, _defineProperty(_objectSpread5, backgroundUrlKey, undefined), _defineProperty(_objectSpread5, backgroundIdKey, undefined), _defineProperty(_objectSpread5, backgroundPositionKey, undefined), _defineProperty(_objectSpread5, backgroundOpacityKey, undefined), _objectSpread5))
          });
          return;
        }

        editPost({
          meta: _objectSpread(_objectSpread({}, meta), {}, (_objectSpread6 = {}, _defineProperty(_objectSpread6, backgroundUrlKey, media.url), _defineProperty(_objectSpread6, backgroundIdKey, media.id + ''), _objectSpread6))
        });
      },
      allowedTypes: ALLOWED_MEDIA_TYPES,
      ...
      onClick: function onClick() {
        ...
        editPost({
          meta: _objectSpread(_objectSpread({}, meta), {}, (_objectSpread7 = {}, _defineProperty(_objectSpread7, backgroundUrlKey, ''), _defineProperty(_objectSpread7, backgroundIdKey, ''), _defineProperty(_objectSpread7, backgroundPositionKey, ''), _defineProperty(_objectSpread7, backgroundOpacityKey, ''), _objectSpread7))
        });
      }
      ...
      onChange: function onChange(focalPoint) {
        editPost({
          meta: _objectSpread(_objectSpread({}, meta), {}, _defineProperty({}, backgroundPositionKey, "".concat(focalPoint.x * 100, "% ").concat(focalPoint.y * 100, "%")))
        });
      }
    }), !!meta[backgroundUrlKey] && e(RangeControl, {
      label: __('Opacity', 'slide'),
      ...
      onChange: function onChange(value) {
        editPost({
          meta: _objectSpread(_objectSpread({}, meta), {}, _defineProperty({}, backgroundOpacityKey, value + ''))
        });
      }
    })), e(PluginDocumentSettingPanel, {
      name: 'slide-palette',
...
},{"./font-picker":"font-picker.js","./font-weight-picker":"font-weight-picker.js","./code-editor":"code-editor.js"}],"entry.js":[function(require,module,exports) {
"use strict";
...
require("./plugin");
},{"./block-attributes":"block-attributes.js","./resize":"resize.js","./data-subscription":"data-subscription.js","./fragment":"fragment.js","./block":"block.js","./plugin":"plugin.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
